...
You can use an ebook in .epub and .txt format, and/or audiobook in .mp3 or .m4b, and/or a video downloaded from the web (see [Video from Web](#video)).
...
MiningCat is free software, released under the [GNU Affero General Public License v3.0 or later](https://github.com/linlin56/MiningCat/blob/main/LICENSE) (AGPL-3.0-or-later).
